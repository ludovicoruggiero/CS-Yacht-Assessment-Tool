...
Admins see the same list with a gear icon to open editing tools. The admin panel
shows two tabs: one to create guidelines and another to manage all lookup
tables (target groups, implementation groups, hull types, propulsion types,
